...
public class StopWords {
	...
	public String[] stopwords = {
			...
			"afterwards", "again", "against", "aint", "all", "allow", "allows", "almost", "alone", "along", 
			"already", "also", "although", "always", "am", "among", "amongst", "an", "and", "another", "any", 
			"anybody", "anyhow", "anyone", "anything", "anyway", "anyways", "anywhere", "apart", "appear", 
			"appreciate", "appropriate", "are", "arent", "around", "as", "aside", "ask", "asking", "associated", 
			...
			"better", "between", "beyond", "both", "brief", "but", "by", "cmon", "cs", "came", "can", "cant", 
			...
			"wont", "wonder", "would", "would", "wouldnt", "yes", "yet", "you", "youd", "youll", "youre", "youve", 
			"your", "yours", "yourself", "yourselves", "zero"
			};
	
	public Set<String> stopWordSet = new HashSet<String>(Arrays.asList(stopwords));
	
	File dir = new File("/Users/franclincabral/Documents/CIN/MineraçãoWeb/IR-project/Documents"); //TODO: DECIDIR QUAL PASTA VAI GUARDAR OS DOCUMENTOS
